...
Kirigami.ApplicationWindow {
    ...
    property bool available: !printersModel.serverUnavailable && printers.count > 0
    onAvailableChanged: {
        print("AVAILABLE CHANGED", available)
    ...
    Component {
        ...
        JobView {
            title: "%1 for %2".arg(currentFilterText).arg(printers.currentItem?.info)
