...
void NewPrinterNotification::GetReady()
{
    ...
    const auto defAction = notify->addAction(i18nc("@action:button", "Configure…"));
    connect(defAction, &KNotificationAction::activated, this, [notify]() {
        ProcessRunner::openKCM({}, notify->xdgActivationToken().toUtf8());
    });
    notify->sendEvent();
}
                                                      ...
                                                      const QString &arg)
{
    ...
    connect(addAction, &KNotificationAction::activated, this, [notify]() {
...
void NewPrinterNotification::notifyDriverCheck(KNotification *notify, const QString &name)
{
    ...
    connect(request, &KCupsRequest::finished, this, [this, notify, name](KCupsRequest *request) {
        ...
        if (driver.isEmpty()) {
            ...
            connect(configAction, &KNotificationAction::activated, this, [name, notify]() {
