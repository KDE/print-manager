...
int main(int argc, char **argv)
{
    ...
    KAboutData aboutData(QStringLiteral("plasma.printqueue"),
                         i18nc("@info:credit", "Plasma Print Queue Manager"),
                         QStringLiteral(PM_VERSION),
                         i18nc("@info:credit", "Manage print job queues"),
    ...
    QGuiApplication::setWindowIcon(QIcon::fromTheme(u"printer"_s));
