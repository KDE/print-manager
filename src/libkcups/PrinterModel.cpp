...
bool PrinterModel::setResolvedUri(QList<KCupsPrinter>::iterator printer)
{
...
void PrinterModel::setModelItem(const KCupsPrinter &printer)
{
    ...
    setResolvedUri(std::ranges::find(m_printers, printer.name(), &KCupsPrinter::name));
}
