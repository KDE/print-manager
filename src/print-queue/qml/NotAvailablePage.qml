...
Kirigami.Page {
    ...
    Component {
        ...
        Kirigami.PlaceholderMessage {
            ...
            explanation: i18nc("@info:usagetip", "Verify that the CUPS system service is active or check: <a href=\"%1\">%2 Support</a>", KOSRelease.supportUrl, KOSRelease.prettyName)
    ...
    Component {
        ...
        Kirigami.PlaceholderMessage {
            ...
            explanation: i18nc("@info:usagetip", "Check for issues here: <a href=\"%1\">%2 Issues</a>", KOSRelease.bugReportUrl, KOSRelease.prettyName)
            onLinkActivated: link => Qt.openUrlExternally(link)
        }
    }
