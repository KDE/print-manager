...
{
    exec(u"configure-printer"_s
         , {printerName}
         , u"org.kde.ConfigurePrinter"_s);
}

void ProcessRunner::openPrintQueue(const QString& printerName)
{
    exec(u"kde-print-queue"_s
         , {printerName}
         , u"org.kde.PrintQueue"_s);
}

void ProcessRunner::addPrinter()
{
    exec(u"kde-add-printer"_s
         , {u"--add-printer"_s}
         , u"org.kde.kde-add-printer"_s);
}

void ProcessRunner::addPrinterFromDevice(const QString &device)
{
    exec(u"kde-add-printer"_s
         , {u"--new-printer-from-device"_s, device}
         , u"org.kde.kde-add-printer"_s);
}
