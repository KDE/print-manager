...
Kirigami.ScrollablePage {
    ...
    Kirigami.CardsListView {
        ...
        Kirigami.PlaceholderMessage {
            ...
            text: i18nc("@info:status Print jobs not found in the print queue", "No %1", root.title)
        ...
        QQC2.Menu {
            ...
            Repeater {
                ...
                delegate: QQC2.MenuItem {
                    ...
                    text: i18nc("@action:inmenu Move the job to the other print queue", "Move to %1", info)
        ...
        component DragJobArea: MouseArea {
            ...
            cursorShape: {
                if (da.enabled) {
                    return ma.containsPress ? Qt.ClosedHandCursor : Qt.OpenHandCursor
                } else {
